/* global process, console */ // Add global declarations for ESLint
...
const TARGETS = [
    {
        src: 'src/index.html',
        transform: (contents) => {
            // Default base href to '/' for hash routing compatibility
            return contents.toString()
            .replace('__BASE_HREF__', process.env.BASE_HREF || '/'); // Align .replace with return
            // Removed the seemingly incomplete .replace('__')
        }
    },
